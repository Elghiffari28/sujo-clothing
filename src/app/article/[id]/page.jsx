  ...
  if (loading)
    return (
      <div className="p-12 bg-white flex justify-center items-center">
        <p className=" text-center animate-pulse md:text-xl font-bold">
          Loading...
        </p>
      </div>
    );
  if (!artikel) return <p className="p-12">Artikel tidak ditemukan</p>;

  return (
    <div className="max-w-6xl mx-auto px-6 bg-white py-16 lg:mt-16 lg:mb-6">
      {/* Judul */}
      ...
      {/* Konten HTML */}
      <div
        className="prose ProseMirror max-w-none"
